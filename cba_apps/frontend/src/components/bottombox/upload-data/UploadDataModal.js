...
import { Button, Modal, ModalHeader, ModalBody, ModalFooter, Form, Input, NavLink } from 'reactstrap';
	...
	render() {
		...
		return (
			<Fragment>
				...
				<Modal scrollable={true} className="modal-lg modal-main" isOpen={this.state.modal} toggle={this.toggle}>
