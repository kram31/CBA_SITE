              ...
              <Col>
                <Form>
                  <Row>
                    ...
                    <Col>
                      <Label for="operator_lan_id">Operator Lan ID</Label>
                      <Input
                        type="input"
                  ...
                  <Row className="mt-3">
                    <Col>
                      <Label for="skill">
                        Skills{" "}
                        <i
                          onClick={() => this.handleModal(skill_table)}
                          style={{
                            color: "green",
                            cursor: "pointer"
                          }}
                    ...
                    <Col>
                      <Label for="team_lead">
                        Team Lead{" "}
                        <i
                          onClick={() => this.handleModal(team_lead_table)}
                          style={{
                            color: "green",
                            cursor: "pointer"
                          }}
              ...
              {this.props.agent.surveys && (
                <Col md={6}>
                  ...
                  <Row>
                    <Col>
                      <StackedBarChart
                        filtered_list={this.props.filtered_agent_data}
                        chart_parent={
                          <Row>
                            <Col>
                              <Bar
