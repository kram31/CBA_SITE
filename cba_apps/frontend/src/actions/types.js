...
export const COLLAPSE_COMPONENT = "COLLAPSE_COMPONENT";

export const LOADING_TOGGLE = "LOADING_TOGGLE";
export const CLEAR_UPLOAD_DETAILS = "CLEAR_UPLOAD_DETAILS";
export const DELETE_AGENT_SKILL = "DELETE_AGENT_SKILL";
export const ADD_AGENT_SKILL = "ADD_AGENT_SKILL";
export const GET_CSAT_ADMIN = "GET_CSAT_ADMIN";
export const REMOVE_CSAT_ADMIN = "REMOVE_CSAT_ADMIN";
export const ADD_CSAT_ADMIN = "ADD_CSAT_ADMIN";
export const GET_USERS = "GET_USERS";
export const GET_ACCESS_REQUEST = "GET_ACCESS_REQUEST";
export const REQUEST_ACCESS = "REQUEST_ACCESS";
export const DELETE_REQUEST_ACCESS = "DELETE_REQUEST_ACCESS";
...
export const DELETE_TEAMLEAD = "DELETE_TEAMLEAD";
export const EDIT_TEAMLEAD = "EDIT_TEAMLEAD";
export const ADD_TEAMLEAD = "ADD_TEAMLEAD";
export const GET_TEAMLEADS = "GET_TEAMLEADS";
export const GET_CBA_TEAMS = "GET_CBA_TEAMS";
export const EDIT_CBA_TEAMS = "EDIT_CBA_TEAMS";
export const DELETE_CBA_TEAMS = "DELETE_CBA_TEAMS";

export const ADD_CBA_TEAMS = "ADD_CBA_TEAMS";
...
export const ADD_CSAT_ACCOUNTABLE_TEAM = "ADD_CSAT_ACCOUNTABLE_TEAM";
export const EDIT_CSAT_ACCOUNTABLE_TEAM = "EDIT_CSAT_ACCOUNTABLE_TEAM";
export const DELETE_CSAT_ACCOUNTABLE_TEAM = "DELETE_CSAT_ACCOUNTABLE_TEAM";
...
export const EDIT_RECIPIENTS = "EDIT_RECIPIENTS";
