...
class Ccms(models.Model):
    ...
    mail = models.ForeignKey("Mail", on_delete=models.CASCADE, related_name="mails", blank=True)
    ...
    business_unit = models.ForeignKey("BusinessUnit", on_delete=models.CASCADE, related_name="business_units", blank=True)
    escalation_type = models.ForeignKey("EscalationType", on_delete=models.CASCADE, related_name="escalation_types", blank=True)
    ccms_status = models.ForeignKey("CCMSStatus", on_delete=models.CASCADE, related_name="ccms_status", blank=True)
    ticket_status = models.ForeignKey("TicketStatus", on_delete=models.CASCADE, related_name="ticket_status", blank=True)
    silo = models.ForeignKey("Silo", on_delete=models.CASCADE, related_name="silos", blank=True)
    site_code = models.ForeignKey("SiteCode", on_delete=models.CASCADE, related_name="site_codes", blank=True)
    ccms_owner = models.ForeignKey("CCMSOwner", on_delete=models.CASCADE, related_name="ccms_owners", blank=True)
    accountable_team = models.ForeignKey("AccountableTeam", on_delete=models.CASCADE, related_name="accountable_teams", blank=True)
    ticket_type = models.ForeignKey("TicketType", on_delete=models.CASCADE, related_name="ticket_types", blank=True)
